...
const lowSvg =
    'M 99.168993,419.0375 H 351.33927 c 5.33437,0 9.69886,-5.04 9.69886,-11.2 v -28 c 0,-6.16 -4.36449,-11.2 -9.69886,-11.2 H 99.168993 c -5.334371,0 -9.698857,5.04 -9.698857,11.2 v 28 c 0,6.16 4.364486,11.2 9.698857,11.2 z';
const defaultSvg =
    'm 144.16452,21.032222 h 159.67454 q 123.1748,0 123.1748,128.667868 v 212.64759 q 0,128.66788 -123.1748,128.66788 H 144.16452 q -123.174811,0 -123.174811,-128.66788 V 149.70009 q 0,-128.667868 123.174811,-128.667868 z';
const batteryMapper = {
    critical: {
        svg: criticalSvg,
...
const Battery = ({ variant, ...props }) => {
    ...
    return (
        <View {...props} style={appliedStyles.flexRow}>
            <Canvas
                style={{
                    width: 20,
                    height: 21
                ...
                paint={({ path, scale }) => {
                    ...
                    path(defaultSvg)
                        .lineWidth('41.9638')
                        .stroke(global_icon_Color_light.value) // eslint-disable-line camelcase
                        .path(currBattery.svg)
