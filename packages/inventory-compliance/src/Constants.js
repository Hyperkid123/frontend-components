...
export const ANSIBLE_ICON = (
    <svg version="1.1" id="ansible_icon" width="18px" height="18px" viewBox="0 0 18 18">
        <path
...
const LowSeverityIcon = (
    <svg width="1em" height="1em" viewBox="0 0 18 18" role="img" style={{ verticalAlign: '-0.125em' }} xmlns="http://www.w3.org/2000/svg">
        <path
