...
export const profileRules = [
    {
        ...
        rules: [
            ...
            },
            {
                ...
                description:
                    'The rsyslog service provides syslog-style logging by default on Red Hat Enterprise Linux 7. The rsyslog service can be enabled with the following command: $ sudo systemctl enable rsyslog.service',
                compliant: true,
                remediationAvailable: false,
                identifier: null
            },
