...
import { Form, FormGroup, Grid, GridItem, Radio, FormSelect, FormSelectOption, TextInput, Stack, StackItem } from '@patternfly/react-core';
                                ...
                                {existingRemediations === false ? (
                                    ...
                                    >
                                        {existingRemediations.length ? (
                                            existingRemediations.map(({ id, name }) => <FormSelectOption key={id} value={id} label={name} />)
                                        ) : (
