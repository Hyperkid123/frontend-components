...
class ConditionalFilter extends Component {
    ...
    render() {
        ...
        const activeItem = items && items.length && (items.find((item, key) => item.value === currentValue || key === currentValue) || items[0]);
                                ...
                                <Dropdown
                                    ...
                                    toggle={
                                        ...
                                        >
                                            <FilterIcon size="sm" />
                                            {!hideLabel && (
                                                <span className="ins-c-conditional-filter__value-selector">{activeItem && activeItem.label}</span>
                                            )}
                                        </DropdownToggle>
                                    }
