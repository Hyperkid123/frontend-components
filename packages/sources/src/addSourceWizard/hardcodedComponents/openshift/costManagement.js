...
const REPORTING_OPERATOR_URL =
    'https://docs.openshift.com/container-platform/4.2/metering/configuring-metering/metering-configure-reporting-operator.html';

export const PrerequisiteDescription = () => (
    <TextContent key="description">
        <Text component={TextVariants.p}>Before you begin, install the following prerequisites if not present:</Text>
    </TextContent>
);

export const PrerequisiteOCPText = () => (
    <TextContent key="prerequisite-ocp">
        <Text component={TextVariants.p}>On your OpenShift cluster, install:</Text>
    </TextContent>
);

export const PrerequisiteSystemText = () => (
    <TextContent key="prerequisite-system">
        <Text component={TextVariants.p}>On a system with network access to your OpenShift cluster, install:</Text>
    </TextContent>
);
    ...
    <TextContent className="list-align-top">
        <TextList component="ul">
            <TextListItem component="li">
                <Text component={TextVariants.a} target="_blank" rel="noopener noreferrer" href={OPENSHIFT_INSTALLATION_URL}>
                    OpenShift Container Platform 4.2 or newer
                </Text>
            </TextListItem>
            <TextListItem component="li">
                <Text component={TextVariants.a} target="_blank" rel="noopener noreferrer" href={OPERATOR_METERING_INSTALLATION_URL}>
                    Operator Metering
                </Text>
            </TextListItem>
        </TextList>
...
export const PrerequisiteSystemList = () => (
    <TextContent className="list-align-top">
        <TextList component="ul">
            ...
            <TextListItem component="li">
                <Text component={TextVariants.a} target="_blank" rel="noopener noreferrer" href={ANSIBLE_INSTALLATION_URL}>
                    Ansible
                </Text>
                &nbsp;and the&nbsp;
                <Text component={TextVariants.a} target="_blank" rel="noopener noreferrer" href={EPEL_INSTALLATION_URL}>
                    EPEL repository
                </Text>
            </TextListItem>
            <TextListItem component="li">
                <Text component={TextVariants.a} target="_blank" rel="noopener noreferrer" href={OC_CMD_URL}>
    ...
    <TextContent>
            ...
            <Popover
                ...
                bodyContent={
                    <TextContent>
                        ...
                        <a href={REPORTING_OPERATOR_URL} target="_blank" rel="noopener noreferrer">
                            Learn more
                        </a>
                    </TextContent>
                }
        ...
        <TextContent className="list-align-left">
            <TextList component="ol">
                <TextListItem component="li">
                    Log in to the Red Hat OpenShift Container Platform cluster with an account that has access to the Reporting Operator namespace.
                </TextListItem>
                <TextListItem component="li">
                ...
                <TextListItem component="li">To maintain security, store the token file on a file system with limited access.</TextListItem>
            </TextList>
        </TextContent>
    </TextContent>
);
...
export const ConfigureUsageCollector = () => (
    <TextContent>
        <Text component={TextVariants.p}>The Usage Collector connects to your cluster and collects the data required for Cost Management.</Text>
        <TextContent className="list-align-left">
            <TextList component="ol">
                <TextListItem component="li">
                    Download and install the&nbsp;
                    <a href={USAGE_COLLECTOR_URL} target="_blank" rel="noopener noreferrer">
                        OpenShift Usage Collector
                    </a>
                ...
                <TextListItem component="li">
                    <Text component={TextVariants.p}>
                        Run the <i>ocp_usage.sh</i> script to configure the Usage Collector.
                        <br />
                        Use the following example, substituting values for your OpenShift API endpoint,&nbsp; Reporting Operator namespace, and{' '}
                        <i>reporting-operator</i> token file path:
                    </Text>
                    <Text component={TextVariants.p}>
                        ...
                        <Popover
                            ...
                            bodyContent={
                                <TextContent>
                                    If the oc command line is installed in a different location from&nbsp; /usr/bin/oc on your system, specify the
                                    path using -e OCP_CLI={'</path/to/oc>'}&nbsp; when executing the ocp_usage.sh command.
                                </TextContent>
                            }
                        >
                            <Button variant={ButtonVariant.plain}>
                ...
                <TextListItem component="li">
                    When configuration is complete, you will receive a confirmation message that contains a cluster identifier.
                    <br />
...
export const ClusterIdentifierLabel = () => (
    ...
    <React.Fragment>
        ...
        <Popover
            ...
            bodyContent={
                <Text>
                    The cluster identifier value is stored in <b>~/.config/ocp_usage/config.json</b>
                </Text>
            }
        >
            <Button className="cluster-id-question-button" variant={ButtonVariant.plain}>
                <QuestionCircleIcon />
            </Button>
        </Popover>
    </React.Fragment>
...
export const DataCollectionDescription = () => (
    <TextContent>
        <Text component={TextVariants.p}>Create a cron job to regularly upload data collected by the Usage Collector to Cost Management.</Text>
        <TextContent className="list-align-left">
            <TextList component="ol">
                <TextListItem component="li">
                    ...
                    <Popover
                        ...
                        bodyContent={
                            <TextContent>
                                When you install Operator Metering for Red Hat OpenShift Container Platform,&nbsp; the <i>reporting-operator</i>{' '}
                                service account is created in the Reporting Operator namespace.&nbsp;
                                <a target="_blank" rel="noopener noreferrer" href={OPERATOR_METERING_URL}>
                                    Learn more
                                </a>
                            </TextContent>
                        }
                ...
                <TextListItem component="li">Click Next to finish adding the OpenShift cluster as a source.</TextListItem>
            </TextList>
        </TextContent>
    </TextContent>
);
