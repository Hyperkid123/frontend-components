...
export const ConfigureResourceGroupAndStorageAccount = () => (
    <TextContent>
        ...
        <Text component={TextVariants.p}>After configuring a resource group and storage account in the Azure portal, enter the following:</Text>
    </TextContent>
);
...
export const ServicePrincipalDescription = () => (
    <TextContent>
        <Text component={TextVariants.p}>
            ...
            <Text rel="noopener noreferrer" target="_blank" component={TextVariants.a} href={AZURE_CREDS_URL}>
                Learn more
            </Text>
        </Text>
        <Text component={TextVariants.p}>Run the following command in Cloud Shell to obtain your Subscription ID and enter it further below</Text>
...
export const CreateActiveDirectory = () => (
    <TextContent>
        <Text component={TextVariants.p}>
            Run the following command in Cloud Shell to create an Active Directory application and assign it to a role using all default selections.
...
export const ExportSchedule = () => (
    <TextContent>
        <Text component={TextVariants.p}>
            ...
            <Text rel="noopener noreferrer" target="_blank" component={TextVariants.a} href={RECURRING_TASK_URL}>
                Learn more
            </Text>
        </Text>
        <TextContent className="list-align-left">
            <TextList component={TextListVariants.ol}>
                <TextListItem component={TextListItemVariants.li}>From the Azure portal, add a new export.</TextListItem>
                <TextListItem component={TextListItemVariants.li}>
                    Provide a name for the container and directory path, and specify the below settings to create the daily export. Leave all other
        ...
        <TextList className="export-table" component={TextListVariants.dl}>
            ...
            <TextListItem component={TextListItemVariants.dd}>Daily export for billing-period-to-date costs.</TextListItem>
            <TextListItem component={TextListItemVariants.dt}>
                <Text component={TextVariants.b}>Storage account name</Text>
            </TextListItem>
            <TextListItem component={TextListItemVariants.dd}>Storage account name created earlier.</TextListItem>
        </TextList>
    </TextContent>
);
