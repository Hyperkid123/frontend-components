...
export const IAMRoleDescription = () => (
    <TextContent>
        <Text component={TextVariants.p}>To delegate account access, create an IAM role to associate with your IAM policy.</Text>
        <TextList>
...
export const IAMPolicyDescription = ({ formOptions }) => {
    ...
    if (!s3Bucket) {
        return <Text component={TextVariants.p}>Something went wrong, you are missing bucket value.</Text>;
    }
    ...
    return (
        <TextContent>
            ...
            <TextList>
                <TextListItem>
                    Sign in to the{' '}
                    <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/console.html" rel="noopener noreferrer" target="_blank">
...
export const TagsDescription = () => (
    <TextContent>
        <Text component={TextVariants.p}>
            To use tags to organize your AWS resources in the cost management application, activate your tags in AWS to allow them to be imported
            automatically.
        </Text>
        <TextList component={TextListVariants.ol}>
...
export const ArnDescription = () => (
    <TextContent>
        <Text component={TextVariants.p}>To enable account access, capture the ARN associated with the role you just created.</Text>
        <TextList>
