    ...
    openshift: {
        ...
        endpoint: {
            url: {
                ...
                isRequired: true,
                validate: [{ type: validatorTypes.REQUIRED }, { type: validatorTypes.URL, message: 'The URL is not formatted correctly.' }]
            },
            ...
            additionalFields: [
                {
                    ...
                    Content: () => (
                        <TextContent key="2">
                            <Text component={TextVariants.p}>Provide the OpenShift Container Platform URL and SSL certificate.</Text>
                        </TextContent>
                    )
                }
            ]
